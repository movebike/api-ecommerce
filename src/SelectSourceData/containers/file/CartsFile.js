const fs = require('fs')
const Cart = require('../../../models/file/cart')
const Product = require('../../containers/file/ProductsFile')
const productsCases = new Product('./data/products.json')
